...
// ✅ Local + Production allowed origins
const allowedOrigins = [
  process.env.NEXT_FRONTEND_URL,
  process.env.ADMIN_FRONTEND_URL,
  process.env.REACT_NATIVE_FRONTEND_URL,
  process.env.LANDING_PAGE_URL,

  // Local frontend / console URLs
  "http://localhost:3000",
  "http://localhost:5173",
  "http://localhost:5174",
  "http://localhost:5175",
...
app.use(
  cors({
    origin: function (origin, callback) {
      // Allow Postman, mobile apps, SSR requests
      if (!origin) return callback(null, true);

      // Allow sslip.io staging domains
